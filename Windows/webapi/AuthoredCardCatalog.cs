        ...
        private static readonly IReadOnlyDictionary<string, AuthoredCardDefinition> Entries =
            new Dictionary<string, AuthoredCardDefinition>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                [BuildKey("BACKGROUND", "AnimatedBubble")] = new(
                    ...
                    "BUBL",
                    "AnimatedBubble",
                    "A buoyant field of translucent spheres rising through a dark liquid plane. It feels playful at first glance, but the layered refractions keep it from reading as novelty wallpaper.",
                    3,
                    0,
                    "Background",
                    "BACKGROUND"
                ...
                [BuildKey("NULLPROVIDER", "Fifth Dimension")] = new(
                    ...
                    "5DIM",
                    "Fifth Dimension",
                    "A rotating penteract projected down through higher dimensions, with color keyed to the fifth-axis depth. It makes the crash field feel like geometry escaping ordinary space.",
                    5,
                    0,
                    "Null Provider",
                    "NULL PROVIDER"
                ...
                [BuildKey("WEBMODULE", "Continue")] = new(
                    ...
                    "CONT",
                    "Continue",
                    "The campaign hub and deck-builder spine of BrokenNes: ROM selection, core loadout, reward reveals, progression routing, and return-from-achievement workflow all converge here.",
                    5,
                    0,
                    "Webmodule",
                    "WEBMODULE WEB"
                ...
                [BuildKey("WEBMODULE", "GlitchHarvester")] = new(
                    ...
                    "A full corruption workflow manager for base states, stash and stockpile handling, RTC configuration, crash behavior, and ImagineBug integration from a single widget surface.",
                    5,
                    0,
                    "Webmodule",
                    "WEBMODULE WIDGET"
                ...
                [BuildKey("WEBMODULE", "HexEditor")] = new(
                    ...
                    "HEXR",
                    "Hex Editor",
                    "A high-throughput memory inspector with virtual scrolling, live refresh, inline byte editing, and heatmap tracking for visible cells. It is the raw RAM bench for the emulator.",
                    5,
                    0,
                    "Webmodule",
                    "WEBMODULE WIDGET"
                ...
                [BuildKey("WEBMODULE", "ImagineBug")] = new(
                    ...
                    "IMAG",
                    "Target the Beam",
                    "A standalone Imagine overlay for creating a savestate, drawing a scanline target band, and rerunning the beam-selection workflow without opening the full harvester UI.",
                    5,
                    0,
                    "Webmodule",
                    "WEBMODULE OVERLAY"
                ...
                [BuildKey("WEBMODULE", "Options")] = new(
                    ...
                    "OPTS",
                    "Options",
                    "The settings surface for audio levels, feature unlock shortcuts, controller configuration, and save-management actions. It is the operational control panel for player-facing preferences.",
                    4,
                    0,
                    "Webmodule",
                    "WEBMODULE WEB"
                ...
                [BuildKey("WEBMODULE", "RomManager")] = new(
                    ...
                    "ROMS",
                    "ROM Manager",
                    "The cartridge library surface for importing, filtering, inspecting, and deleting ROMs while cross-linking catalog metadata and achievement coverage. It is the collection gatekeeper.",
                    5,
                    0,
                    "Webmodule",
                    "WEBMODULE WEB"
                ...
                [BuildKey("WEBMODULE", "TimeJump")] = new(
                    ...
                    "TIME",
                    "Time Jump Challenge",
                    "An automated savestate-capture widget that builds a temporal ladder, tracks level progression, and lets the player jump backward through recorded timeline anchors.",
                    5,
                    0,
                    "Webmodule",
                    "WEBMODULE WIDGET"
