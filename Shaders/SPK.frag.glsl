...
// SPK — Prism sparkle & starfield bursts
// Goal: Edge-oriented prism split plus layered procedural spark particles.
// - Edge gradient drives chromatic prism and burst envelope
// - Multi-layer moving starfield with per-star twinkle
// - Radial depth modulation & shimmer overlay
// - Contrast shaping and bloom-like bright moderation
// uStrength: 0.3..3.0 (clamped) scales specAmp & sparkle weighting
varying vec2 vTex;
uniform sampler2D uTex;    // Source frame
uniform float uTime;       // Seconds
uniform vec2 uTexSize;     // Source size
uniform float uStrength;   // 0.3..3 strength
